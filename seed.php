...
/* --------------------------
   OPTIONAL: PREVENT DOUBLE RUN
-------------------------- */
$check = mysqli_query($conn, "SELECT COUNT(*) as total FROM users");
$row = mysqli_fetch_assoc($check);

if ($row['total'] > 0) {
    exit("Seed already executed. No action taken.");
}
...
VALUES
('ADMIN001', 'System', 'Admin', 'N/A', 'admin@dtc.com', '$admin_pass', 'admin', 'N/A', 'N/A', '0000000000', 'active')
");
...
(student_number, first_name, last_name, middle_name, email, password, role, course, year_level, contact_number, account_status)
VALUES
('REG001', 'System', 'Registrar', 'N/A', 'registrar@dtc.com', '$reg_pass', 'registrar', 'N/A', 'N/A', '0000000000', 'active')
");
